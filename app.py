...
def admin_feedbacks():
    # Verificação de acesso feita no frontend
...
@app.route('/admin')
def admin():
    # Verificar se a senha foi inserida corretamente (via sessionStorage no frontend)
    # A verificação real é feita no frontend via JavaScript
